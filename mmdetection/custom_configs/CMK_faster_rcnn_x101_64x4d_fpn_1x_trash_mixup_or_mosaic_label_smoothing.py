...
model = dict(
    ...
    rpn_head=dict(
        ...
        loss_cls=dict(
            type='LabelSmoothingCrossEntropyLoss', use_sigmoid=True, loss_weight=1.0),
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cls=dict(
                type='LabelSmoothingCrossEntropyLoss', use_sigmoid=False, loss_weight=1.0),
            loss_bbox=dict(type='L1Loss', loss_weight=1.0))),        
    )
...
train_pipeline = [
    dict(type='MixUpOrMosaic', img_scale=(1024, 1024), center_ratio_range=(1.0, 1.0), ratio_range=(1.0,1.0), pad_val=0),
